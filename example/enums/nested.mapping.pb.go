...
// Enum value mapping for Nested_StatusAnnote.
var (
	__Nested_StatusAnnoteMapping_Desc = map[Nested_StatusAnnote]string{
		0:   "\"unspecified\", aaaa",
		1:   "nested1",
		2:   "nested2",
		3:   "nested3",
	...
	__Nested_StatusAnnoteMapping_Value = map[string]Nested_StatusAnnote{
		"\"unspecified\", aaaa": 0,
		"nested1":               1,
		"nested2":               2,
		"nested3":               3,
...
// IntoNumber returns the enum value as an integer.
func (x Nested_StatusAnnote) IntoNumber() int32 {
	return int32(x)
}

// IntoNumberString returns the enum value as an integer string.
func (x Nested_StatusAnnote) IntoNumberString() string {
	return strconv.FormatInt(int64(x), 10)
}
...
// StatusAnnote 状态值
// #[Enum]
// [0:\"unspecified\", aaaa,1:nested1,2:nested2,3:nested3,4:,999:end]
func (x Nested_StatusAnnote) MappingDescriptor() string {
	return __Nested_StatusAnnoteMapping_Desc[x]
}

// EnumCount the number of enum values.
func (Nested_StatusAnnote) EnumCount() int {
	return 6
}

// GetNested_StatusAnnoteValue get mapping value
// StatusAnnote 状态值
// #[Enum]
// [0:\"unspecified\", aaaa,1:nested1,2:nested2,3:nested3,4:,999:end]
func GetNested_StatusAnnoteValue(s string) int {
	return int(__Nested_StatusAnnoteMapping_Value[s])
}
...
// Enum value mapping for Nested_Nested1_TypeAnnote.
var (
	__Nested_Nested1_TypeAnnoteMapping_Desc = map[Nested_Nested1_TypeAnnote]string{
		0: "禁用",
		1: "启用",
	}
	__Nested_Nested1_TypeAnnoteMapping_Value = map[string]Nested_Nested1_TypeAnnote{
		"禁用": 0,
		"启用": 1,
	}
)
...
// IntoNumber returns the enum value as an integer.
func (x Nested_Nested1_TypeAnnote) IntoNumber() int32 {
	return int32(x)
}

// IntoNumberString returns the enum value as an integer string.
func (x Nested_Nested1_TypeAnnote) IntoNumberString() string {
	return strconv.FormatInt(int64(x), 10)
}
...
// #[Enum]
// [0:禁用,1:启用]
func (x Nested_Nested1_TypeAnnote) MappingDescriptor() string {
	return __Nested_Nested1_TypeAnnoteMapping_Desc[x]
}

// EnumCount the number of enum values.
func (Nested_Nested1_TypeAnnote) EnumCount() int {
	return 2
}

// GetNested_Nested1_TypeAnnoteValue get mapping value
// TypeAnnote 类型
// #[Enum]
// [0:禁用,1:启用]
func GetNested_Nested1_TypeAnnoteValue(s string) int {
	return int(__Nested_Nested1_TypeAnnoteMapping_Value[s])
}
